<x-admin.layout>
    <x-admin.page-title title="Kamar" />
    <div class="page-body">
                                ...
                                <table class="table table-vcenter card-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="post" action="{{ route('admin.room.destroy', $data->id)}}">
                                                    @method("delete")
                                                    @csrf
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.room.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="room_class" class="form-label required">Kelas Kamar</label>
                        ...
                        <div class="mb-3">
                            <label for="room_name" class="form-label required">Nama Kamar</label>
