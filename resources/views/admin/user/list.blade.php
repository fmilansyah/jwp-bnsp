<x-admin.layout>
    <x-admin.page-title title="Administrator" />
    <div class="page-body">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.user.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="name" class="form-label required">Nama Admin</label>
                        ...
                        <div class="mb-3">
                            <label for="confirm_password" class="form-label required">Konfirmasi Kata Sandi</label>
